...
export const DEFAULT_USER_ID = '671fbb0f-afb2-472c-82f8-5c9be494ad29';
...
export function getAuthCredentials() {
  ...
  if (!userId || userId === '12345678-1234-1234-1234-123456789012' || userId === '00000000-0000-0000-0000-000000000000') {
    userId = DEFAULT_USER_ID;
